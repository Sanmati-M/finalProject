  ...
  <div id="featured" class="clear">
    <div class="image-block">
      <table width="200" border="1">
        <tr>
          <td><h3 align="left" class="style21">Customers </h3>
            <p align="justify" class="post-info">
              <!-- featured ends -->
            </p>
            <table width="562" height="109" border="0" >
              <tr>
                <td width="52" height="43" bgcolor="#295177"><div align="center" class="style23">Name </div></td>
                <td width="71" bgcolor="#295177"><div align="center" class="style23">UserName </div></td>
                <td width="59" bgcolor="#295177"><div align="center" class="style23">Address</div></td>
                <td width="71" bgcolor="#295177"><div align="center"><span class="style23">MobileNo</span></div></td>
                <td width="75" bgcolor="#295177"><div align="center"><span class="style23">Email </span></div></td>
                <td width="54" bgcolor="#295177"><div align="center"><span class="style23">Latitude</span></div></td>
                <td width="64" bgcolor="#295177"><div align="center"><span class="style23">Longitude</span></div></td>
              </tr>
              <%
                                        try {
