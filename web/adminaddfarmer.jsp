...
<div id="wrap">
  ...
  <div id="featured" class="clear">
    ...
    <div class="text-block">
      <form id="form1" method="post" action="AdminAddFarmer">
        <table width="404" height="432" border="0" align="center">
          <tr>
            <td width="157" height="50"><div align="center" class="style29"> Full Name </div></td>
            <td width="237"><label>
              <input name="fullname" type="text" id="fullname" />
            </label></td>
          </tr>
          <tr>
            <td height="49" class="style34"><div align="center" class="style25"><span class="style29">Mobile Number </span></div></td>
            <td><input name="mobileno" type="text" id="mobileno" /></td>
          </tr>
          <tr>
            <td height="49" class="style34"><div align="center" class="style25"><span class="style29">Address</span></div></td>
            <td><label>
              <input name="address" type="text" id="address" value="" />
            </label></td>
          </tr>
          <tr>
            <td height="49" class="style34"><div align="center" class="style25"><span class="style29">Farm Location </span></div></td>
            <td><label>
              <input name="farmlocation" type="text" id="farmlocation" />
            </label></td>
          </tr>
          <tr>
            <td height="49" class="style34"><div align="center" class="style25"><span class="style29">Farm Size </span></div></td>
            <td><label>
              <input name="farmsize" type="text" id="farmsize" />
            </label></td>
          </tr>
          <tr>
            <td height="49" class="style34"><div align="center" class="style25"><span class="style29">Latitude </span></div></td>
            <td><label>
              <input name="lat" type="text" id="lat" />
            </label></td>
          </tr>
          <tr>
            <td height="49" class="style34"><div align="center" class="style25"><span class="style29">Longitude</span></div></td>
            <td><label>
