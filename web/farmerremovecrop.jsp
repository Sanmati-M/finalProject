...
<div id="wrap">
  ...
  <div id="featured" class="clear">
    ...
    <div class="text-block">
      <p>&nbsp;</p>
      <p><span class="style31">REMOVE VEGETABLES</span></p>
      <p>&nbsp;</p>
      <table width="464" height="135" border="0" align="center" >
        <tr>
          <td width="56" bgcolor="#1980AF">&nbsp;</td>
          <td width="83" height="43" bgcolor="#1980AF"><div align="center" class="style23">Veg Name </div></td>
          <td width="84" bgcolor="#1980AF"><div align="center" class="style23">Veg Price </div></td>
          <td width="130" bgcolor="#1980AF"><div align="center" class="style23">Available Quantity </div></td>
		...
		Statement st,st1,st2,st3,st4;
                                    ...
                                    %>
        <tr>
          <form id="form2" method="post" action="RemoveCrop">
            <td><div align="center">
                <label>
