  ...
  <div id="featured" class="clear">
    <div class="image-block">
      <table width="200" border="0" align="center">
        <tr>
          <td><table width="678" height="129" border="0" align="center" >
            <tr>
              <td width="44" bgcolor="#1980AF">&nbsp;</td>
              <td width="58" height="49" bgcolor="#1980AF"><div align="center" class="style23">Name </div></td>
              <td width="61" bgcolor="#1980AF"><div align="center" class="style23">Mobile</div></td>
              <td width="51" bgcolor="#1980AF"><div align="center" class="style23">Addr</div></td>
              <td width="74" bgcolor="#1980AF"><div align="center"><span class="style23">Farm Location </span></div></td>
              <td width="56" bgcolor="#1980AF"><div align="center"><span class="style23">Farm Size </span></div></td>
              <td width="69" bgcolor="#1980AF"><div align="center"><span class="style23">Latitude</span></div></td>
              <td width="79" bgcolor="#1980AF"><div align="center"><span class="style23">Longitude</span></div></td>
              <td width="55" bgcolor="#1980AF"><div align="center"><span class="style23">User Name</span></div></td>
		...
		Statement st,st1,st2,st3,st4;
                                    ...
                                    %>
            <tr>
              <form id="form1" method="post" action="RemoveFarmer">
                <td><div align="center">
                    <label>
