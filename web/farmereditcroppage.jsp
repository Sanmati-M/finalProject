...
<div id="wrap">
  ...
  <div id="featured" class="clear">
    ...
    <div class="text-block">
      ...
      <form id="form1" method="post" action="EditCrop1">
        <table width="348" height="230" border="0" align="center">
          <tr>
            <td width="145" height="50"><div align="center" class="style29"> Veg Name </div></td>
            <td width="177"><label>
          ...
          <tr>
            <td height="70" colspan="2" class="style7"><label>
                <div align="center">
                  ...
                  <input name="Submit2" type="submit" class="style34" value="Update Details" />
                  </span></label>
                </div>
              </label></td>
          </tr>
