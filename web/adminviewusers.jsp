  ...
  <div id="featured" class="clear">
    <div class="image-block">
      <table width="200" border="0" align="left">
        <tr>
          <td><table width="497" height="129" border="0" >
            <tr>
              <td width="52" height="49" bgcolor="#1980AF"><div align="center" class="style23">Name </div></td>
              <td width="71" bgcolor="#1980AF"><div align="center" class="style23">UserName </div></td>
              <td width="59" bgcolor="#1980AF"><div align="center" class="style23">Address</div></td>
              <td width="71" bgcolor="#1980AF"><div align="center"><span class="style23">MobileNo</span></div></td>
              <td width="75" bgcolor="#1980AF"><div align="center"><span class="style23">Email </span></div></td>
