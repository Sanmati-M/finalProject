  ...
  <div id="featured" class="clear">
    <div class="image-block">
      <table width="200" border="0" align="left">
        <tr>
          <td><table width="530" height="129" border="0" align="left" >
            <tr>
              <td width="20" bgcolor="#1980AF">&nbsp;</td>
              <td width="52" height="49" bgcolor="#1980AF"><div align="center" class="style23">Name </div></td>
              <td width="53" bgcolor="#1980AF"><div align="center" class="style23">Mobile</div></td>
              <td width="55" bgcolor="#1980AF"><div align="center" class="style23">Address</div></td>
              <td width="62" bgcolor="#1980AF"><div align="center"><span class="style23">Farm Location </span></div></td>
              <td width="50" bgcolor="#1980AF"><div align="center"><span class="style23">Farm Size </span></div></td>
              ...
              <td width="64" bgcolor="#1980AF"><div align="center"><span class="style23">UserName</span></div></td>
              <td width="55" bgcolor="#1980AF">&nbsp;</td>
            </tr>
            <%
                                        try {
